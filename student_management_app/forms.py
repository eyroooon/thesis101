...
class AddStudentForm(forms.Form):
    ...
    course = forms.ChoiceField(
        label='Course', choices=course_list, widget=forms.Select(attrs={'class': 'form-control'}))
    ...
    profile_pic = forms.FileField(
        label='Profile Pic', widget=forms.FileInput(attrs={'class': 'form-control'}))
...
class EditStudentForm(forms.Form):
    ...
    session_end = forms.DateField(
        label='Session End', widget=DateInput(attrs={'class': 'form-control'}))
    profile_pic = forms.FileField(
        label='Profile Pic', widget=forms.FileInput(attrs={'class': 'form-control'}), required=False)
